...
function Display()
{
    ...
    {
        await axios.get(`http://localhost:5016/api/folders/folder?folderId=${folderId}&folderType=1`,
            {
    ...
    const getBlobContent = (element) =>
    {
        ...
        axios.get(`http://localhost:5016/api/fileoperations/download?guid=${docId}`,
            {
                headers:{
